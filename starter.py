...
data_for_processing = tf.keras.utils.get_file('aclImdb_v1',
                      f'{easy_test_url}', untar=True, cache_dir='.',
                       cache_subdir='')
dataset_dir = os.path.join(os.path.dirname(data_for_processing), 'aclImdb')
